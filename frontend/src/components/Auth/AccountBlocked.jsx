  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900 flex items-center justify-center px-4">
      <motion.div
        ...
        className="max-w-md w-full bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-red-200 dark:border-red-800 p-8"
      >
        {/* Header */}
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-slate-100 mb-2">Account Deactivated</h1>
        ...
        <div className="space-y-4 mb-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100">Need Help?</h3>
          <p className="text-gray-600 dark:text-slate-400 text-sm">
            If you believe this is an error or need to reactivate your account, please contact our support team.
          </p>
          
          <div className="space-y-3">
            <div className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-slate-900 rounded-lg">
              <FiMail className="w-5 h-5 text-emerald-600 dark:text-emerald-400" />
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-slate-100">Email Support</p>
                <p className="text-sm text-gray-600 dark:text-slate-400">{contactEmail}</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-slate-900 rounded-lg">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900 dark:text-slate-100">Phone Support</p>
                <p className="text-sm text-gray-600 dark:text-slate-400">+977-1-4455667</p>
              </div>
            </div>
          </div>
        </div>
