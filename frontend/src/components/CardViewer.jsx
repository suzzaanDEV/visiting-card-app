      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="relative w-full max-w-5xl">
              ...
              >
                ...
                {template && !isLoadingTemplate ? (
                  ...
                  // Fallback design if no template
                  <div 
                ...
                <AnimatePresence>
                  {showQR && (
                    <motion.div
                      ...
                      className="absolute top-6 left-6 bg-white p-6 rounded-2xl shadow-2xl z-10"
                      ref={setQrCodeRef}
                    >
                      <QRCodeCanvas
        ...
        >
          ...
          <motion.button
            ...
            className="flex items-center px-8 py-4 bg-white text-gray-700 rounded-full shadow-lg hover:bg-gray-50 transition-all shadow-gray-200"
          >
            <FaSave className="h-6 w-6 mr-3 text-purple-500" />
