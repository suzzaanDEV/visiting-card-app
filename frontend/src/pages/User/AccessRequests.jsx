        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-2">Manage access requests for your private cards</p>
            </div>
            <button
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">You don't have any access requests for your cards yet.</p>
            </div>
          ) : (
