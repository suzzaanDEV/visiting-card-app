  ...
  const handleApproveRequest = async (requestId) => {
    ...
    try {
      ...
      const response = await fetch(`/api/admin/access-requests/${requestId}/approve`, {
        ...
        body: JSON.stringify({ adminNotes: responseMessage })
      });
  ...
  const RequestCard = ({ request }) => (
    ...
    >
      ...
      <div className="space-y-3 mb-4">
        ...
        <div className="flex items-center space-x-2">
          <FiUser className="h-4 w-4 text-gray-500 dark:text-slate-400" />
          <span className="text-sm text-gray-600 dark:text-slate-400">Owner:</span>
          <span className="text-sm font-medium text-gray-900 dark:text-slate-100">
      ...
      <div className="space-y-6">
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-slate-400">There are no access requests matching your criteria.</p>
          </div>
        ) : (
              ...
              <div className="mb-6">
                ...
                <div className="mb-4">
                  ...
                  <textarea
                    ...
                    className="w-full p-3 border border-gray-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
                    rows="3"
                  />
                </div>
              </div>
