            ...
            <div className="relative w-32 h-32">
              <svg className="w-full h-full" viewBox="0 0 100 100">
                {data.map((d, i) => {
                  ...
                  const radius = 40;
                  const _x = 50 + radius * Math.cos((i * angle) * Math.PI / 180);
                  const _y = 50 + radius * Math.sin((i * angle) * Math.PI / 180);
    ...
    >
      ...
      {change && (
        <div className="flex items-center mt-4">
          ...
          <span className="text-gray-500 dark:text-slate-400 text-sm ml-2">from last period</span>
        </div>
      )}
    </motion.div>
  );
