...
const RecentCards = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-green-50 dark:from-slate-950 dark:to-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <h1 className="text-4xl font-bold text-gray-900 dark:text-slate-100 mb-4">
            <FaRegClock className="inline-block mr-3 text-emerald-600 dark:text-emerald-400" />
            Recent Cards
          </h1>
        ...
        {!loading && cards.length === 0 && (
          ...
          >
            <FaRegClock className="mx-auto h-16 w-16 text-gray-400 dark:text-slate-500 mb-4" />
